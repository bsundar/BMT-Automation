...
public class htmlReport extends BaseConfig
{
	...
	static String main_Location="C:\\Automation_Framework\\BMT_GAIN\\Test_Output\\";
	...
	public boolean createResultFile(String strResultsFolderPath) throws Exception
	{
		...
		objWriter.write("</h3>");		
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:16;COLOR:DARKBLUE\">ENVIRONMENT EXECUTION DETAILS</h3>");
		objWriter.write("<table border = \"CENTER\" \"1\" width = \"20%\" cellspacing=\"0\" cellpadding=\"6\" align=center STYLE = \"BORDER-COLOR:BLACK\">");
		
		
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:14;COLOR:DARKBLUE\">OSNAME:-" +osName+"");
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:14;COLOR:DARKBLUE\">OS ARCHITECTURE:-" +osArch+"");
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:14;COLOR:DARKBLUE\">OS VERSION:-" +osVers+"");
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:14;COLOR:DARKBLUE\">JAVA VERSION:-" +javaVers+"");
		objWriter.write("<h3 align = \"LEFT\" style = \"FONT-SIZE:14;COLOR:DARKBLUE\">BROWSER VERSION:-" +browserName+""+browserVersion+"");
		//objWriter.write(""+osName+);
		...
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"16%\">MODULE NAME</th>");
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"12%\" >PRIORITY</th>");
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"25%\" >EXPECTED RESULT</th>");
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"25%\" >ACTUAL RESULT</th>");
	...
	{	
       ...
       /* File scrnsht =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        ...
        String strScreenshot= screenshot+strAppendDateTime+".png";
