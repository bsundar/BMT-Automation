...
public class TestNG_FileGeneration{
	...
	public static void main (String args[]) throws Exception
	{
		...
		String TeItems= xmlStatus(0,6,0);
		System.out.println("The Value of TNstopTest:"+TeItems);
		
		String tmixeditems= xmlStatus(0,7,0);
		System.out.println("The Value of TNstopTest:"+tmixeditems);
		
		String yteitems= xmlStatus(0,6,1);
		System.out.println("The Value of yuseractions :"+yteitems);
		
		String ymixeditems= xmlStatus(0,7,1);
		System.out.println("The Value of yuseractions :"+ymixeditems);
       ...
       writer.println("</methods>");
		writer.println("</classes>");
		writer.println("<classes>");
       if(yteitems.equals("Y"))				
		{
	   	writer.println("<class name="+'"'+"User_actions."+TeItems+'"'+"/>");
		}
        writer.println("<methods>");
		if(ymixeditems.endsWith("Y"))
				{
			writer.println("<include name='"+tmixeditems+"'/>");
				}       
		writer.println("</methods>");
		writer.println("</classes>");
		writer.println("</test>");
		...
		hf.createResultFile("C:\\Automation _Framework\\BMT_GAIN\\Test_Output");	
