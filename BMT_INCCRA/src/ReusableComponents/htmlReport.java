...
public class htmlReport extends BaseConfig
{
	...
	public boolean createResultFile(String strResultsFolderPath) throws Exception
	{
		...
		objWriter.write("<h3 align = \"CENTER\" style = \"FONT-SIZE:30;COLOR:DARKBLUE\">BMT AUTOMATION SUITE EXECUTION -");
		...
		objWriter.write("</tr>");*/
		objWriter.write("</h3>");		
		objWriter.write("<h3 align = \"CENTER\" style = \"FONT-SIZE:18;COLOR:DARKBLUE\">ENVIRONMENT EXECUTION DETAILS</h3>");
		...
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"14%\">MODULE NAME</th>");
		objWriter.write("<th style = \"BORDER-COLOR:BLACK;FONT-FAMILY:VERDANA;FONT-SIZE:14;COLOR:WHITE;WORD-BREAK:BREAK-ALL\" width = \"9%\" >PRIORITY</th>");
