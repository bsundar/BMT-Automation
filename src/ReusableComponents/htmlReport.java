...
public class htmlReport extends BaseConfig
{
	...
	static String main_Location="C:\\Automation _Framework\\BMT_GAIN\\Test_Output\\";
	...
	public boolean createResultFile(String strResultsFolderPath) throws Exception
	{
		...
		objWriter.write("</h3>");		
		objWriter.write("<h3 align = \"CENTER\" style = \"FONT-SIZE:16;COLOR:DARKBLUE\">ENVIRONMENT EXECUTION DETAILS</h3>");
